...
process.env.ANCHOR_WALLET = '/Users/bg/.config/solana/id.json'
...
async function main() {
  ...
  let tx
  tx = await programBkswap.rpc.setFeeReceiver(
    new PublicKey('7nbCmPsrwWpFGf4u4qVt1dF6y2CvCJ8LyTjqvAcAv9FP'),
    {
      accounts: {
